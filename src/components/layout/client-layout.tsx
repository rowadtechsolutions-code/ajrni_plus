...
const InstallPrompt = lazy(() => import("@/components/layout/install-prompt").then((m) => ({ default: m.InstallPrompt })))
          ...
          <AnimatePresence>
            {showScrollTop && (
              <motion.button
                ...
                aria-label={typeof window !== "undefined" && document.documentElement.lang === "ar" ? "العودة للأعلى" : "Scroll to top"}
              >
